...
import { Menu, ChevronRight, ExternalLink, ChevronDown } from "lucide-react";
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30">
      ...
      <div className="flex items-center gap-3 sm:gap-5">
        ...
        {/* Admin Badge */}
        <div className="hidden sm:flex items-center justify-center px-3 py-1 rounded-full bg-orange-100 text-orange-700 text-xs font-semibold  tracking-wide">
          {user?.roles?.[0] || "Admin"}
        </div>
