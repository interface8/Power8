...
// ------------------------------------------------------------------
// 1. NIGERIA STATES DATA (36 States + FCT Abuja)
// ------------------------------------------------------------------
...
// ------------------------------------------------------------------
// 2. MAJOR CITIES / TOWNS PER STATE (simplified but realistic)
// ------------------------------------------------------------------
...
// ------------------------------------------------------------------
// 4. MAIN ADDRESS SECTION COMPONENT (with dynamic city based on state)
// ------------------------------------------------------------------
interface AddressSectionProps {
  title: string;
  description: string;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        "
      >
        {/* Street Address - manual input (as requested, stays as input field) */}
        <div>
          <label
            htmlFor={`${title}-street`}
            className="
