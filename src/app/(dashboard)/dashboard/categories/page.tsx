...
import { Plus, Pencil, Trash2, FolderTree, Calendar, Hash, Search, ChevronLeft, ChevronRight, Download, X, Copy, Check, Trash } from "lucide-react";
...
export default function CategoriesPage() {
  ...
  const resetForm = () => {
    setFormData({ name: "", description: "", sort: 0 });
    setFormErrors({});
  ...
  // Export to CSV
  const exportToCSV = () => {
    const headers = ["Name", "Description", "Sort Order", "Date Created"];
        ...
        <TableBody>
          {[...Array(5)].map((_, i) => (
            <TableRow key={i}>
              ...
              <TableCell><div className="flex justify-center gap-2"><div className="h-8 w-8 bg-gray-200 rounded animate-pulse" /><div className="h-8 w-8 bg-gray-200 rounded animate-pulse" /></div></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
